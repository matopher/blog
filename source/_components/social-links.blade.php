<div class="flex items-center justify-around max-w-xs mx-auto pt-6">
    <div class="px-1 mx-4">
        <a href="https://twitter.com/matopher" target="_blank" rel="noopener">
            <svg width="26" height="22" viewBox="0 0 26 22" xmlns="http://www.w3.org/2000/svg" class="fill-current w-4 hover:text-blue-700est">
    ...
    <div class="px-1 mx-4">
        <a href="https://www.youtube.com/channel/UC66SdWwBo-enFmuCzrxsa1g" target="_blank" rel="noopener">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-4 hover:text-blue-700est">
    ...
    <div class="px-1 mx-4">
        <a href="https://www.github.com/matopher" target="_blank" rel="noopener">
            <svg viewBox="0 0 24 24" class="fill-current w-4 hover:text-blue-700est">
    ...
    <div class="px-1 mx-4">
        <a href="https://www.linkedin.com/in/matthewchristopherwoods" target="_blank" rel="noopener">
            <svg width="25" height="24" viewBox="0 0 25 24" xmlns="http://www.w3.org/2000/svg" class="fill-current w-4 hover:text-blue-700est">
    ...
    <div class="px-1 mx-4">
        <a href="https://www.instagram.com/justthegoodparts/" target="_blank" rel="noopener">
            <svg viewBox="0 0 512 512" class="fill-current w-6 h-6 hover:text-blue-700est">
