<template>
    <div class="flex flex-1 justify-end items-center text-right px-4">
        ...
        >
            <label for="search" class="hidden">Search Articles</label>

            <input
                id="search"
                v-model="query"
                ref="search"
                class="transition-fast relative block h-10 w-full lg:w-1/2 lg:focus:w-3/4 bg-gray-100 border border-gray focus:border-blue-400 outline-none cursor-pointer text-gray-700 px-4 pb-0"
