    ...
    <body class="flex flex-col justify-between min-h-screen bg-grey-lightest text-grey-darkest leading-normal font-sans">
        ...
        <footer class="bg-white text-center text-sm mt-12 py-4" role="contentinfo">
            <div class="flex items-center justify-center mx-auto pt-4">
                <div class="px-1 mx-4">
                    <a href="https://twitter.com/matopher">
                ...
                <div class="px-1 mx-4">
                    <a href="https://www.youtube.com/channel/UC66SdWwBo-enFmuCzrxsa1g">
                ...
                <div class="px-1 mx-4">
                    <a href="https://www.github.com/matopher">
                ...
                <div class="px-1 mx-4">
                    <a href="https://www.linkedin.com/in/matthewchristopherwoods">
