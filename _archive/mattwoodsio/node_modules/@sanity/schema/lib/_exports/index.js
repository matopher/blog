...
function buildTitle$1(type) {
  ...
  return "Cross dataset reference to ".concat(humanize$1(arrify__default.default(type.to).map(toType => toType.title || capitalize__default.default(toType.type)), "or").toLowerCase());
}
const CrossDatasetReferenceType = {
  ...
  extend(subTypeDef, createMemberType) {
    ...
    const parsed = Object.assign(pick__default.default(CROSS_DATASET_REFERENCE_CORE, OVERRIDABLE_FIELDS$b), subTypeDef, {
...
const ObjectType = {
  ...
  extend(rawSubTypeDef, createMemberType) {
    ...
    const parsed = Object.assign(pick__default.default(this.get(), OVERRIDABLE_FIELDS$8), subTypeDef, {
      type: this.get(),
...
const FileType = {
  ...
  extend(rawSubTypeDef, createMemberType) {
    ...
    const parsed = Object.assign(pick__default.default(FILE_CORE, OVERRIDABLE_FIELDS$6), subTypeDef, {
      type: FILE_CORE,
      title: subTypeDef.title || (subTypeDef.name ? startCase__default.default(subTypeDef.name) : ""),
      options,
      fields: subTypeDef.fields.map(fieldDef => {
...
function buildTitle(type) {
  ...
  return "Reference to ".concat(humanize(arrify__default.default(type.to).map(toType => toType.title), "or").toLowerCase());
}
const ReferenceType = {
  get() {
