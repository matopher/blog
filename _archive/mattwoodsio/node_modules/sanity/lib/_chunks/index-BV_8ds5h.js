...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from './StructureToolProvider-DbWjiGhG.js';
...
const paneMap = {
  component: lazy(() => import('./index-CvUNfby3.js')),
  document: lazy(() => import('./pane-4z62EsJc.js')),
  documentList: lazy(() => import('./pane-BmmpvOqL.js')),
  list: lazy(() => import('./index-Dkzo_-Bz.js'))
};
...
//# sourceMappingURL=index-BV_8ds5h.js.map
