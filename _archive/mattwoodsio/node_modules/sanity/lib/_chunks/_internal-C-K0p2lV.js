...
const validateDocumentsCommand$1 = {
  ...
  helpText: helpText$c,
  action: async (args, context) => {
    const mod = await import('./validateAction-CEBRrHh_.js');
    return mod.default(args, context);
  }
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-BRscwb_W.js');
    return mod.default(args, context);
  },
  helpText: helpText$9
};
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-DokNNimK.js');
    return mod.default(args, context);
  },
  helpText: helpText$8
};
...
//# sourceMappingURL=_internal-C-K0p2lV.js.map
