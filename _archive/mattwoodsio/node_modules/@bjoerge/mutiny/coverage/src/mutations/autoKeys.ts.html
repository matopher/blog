...
<head>
    <title>Code coverage report for src/mutations/autoKeys.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/mutations</a> autoKeys.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {isObject} from '../utils/isObject'
import {
  insert as _insert,
  replace as _replace,
  upsert as _upsert,
...
&nbsp;
  ...
  const upsert = <span class="fstat-no" title="function not covered" >&lt;</span>
<span class="cstat-no" title="statement not covered" >    Pos extends RelativePosition,</span>
<span class="cstat-no" title="statement not covered" >    ReferenceItem extends Index | KeyedPathElement,</span>
...
<span class="cstat-no" title="statement not covered" >  ) =&gt; _upsert(ensureKeys(items), position, referenceItem)</span>
&nbsp;
  const replace = <span class="fstat-no" title="function not covered" >&lt;</span>
<span class="cstat-no" title="statement not covered" >    Pos extends RelativePosition,</span>
<span class="cstat-no" title="statement not covered" >    ReferenceItem extends Index | KeyedPathElement,</span>
<span class="cstat-no" title="statement not covered" >  &gt;(</span>
<span class="cstat-no" title="statement not covered" >    items: Item[],</span>
<span class="cstat-no" title="statement not covered" >    position: Pos,</span>
<span class="cstat-no" title="statement not covered" >    referenceItem: ReferenceItem,</span>
<span class="cstat-no" title="statement not covered" >  ) =&gt; _replace(ensureKeys(items), referenceItem)</span>
&nbsp;
