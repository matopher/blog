...
<head>
    <title>Code coverage report for src/apply/patch/applyNodePatch.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/apply/patch</a> applyNodePatch.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">78.44% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>91/116</span>
            </div>
...
<span class="cline-any cline-yes">61x</span>
<span class="cline-any cline-yes">61x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {isArrayElement, isPropertyElement, stringify} from '../../path'
...
<span class="cstat-no" title="statement not covered" >    `Cannot apply operation of type "${op.type}" to path ${stringify(</span>
<span class="cstat-no" title="statement not covered" >      path,</span>
<span class="cstat-no" title="statement not covered" >    )} on ${typeof value} value`,</span>
<span class="cstat-no" title="statement not covered" >  )</span>
<span class="cstat-no" title="statement not covered" >}</span>
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  // If the given selector could not be found, return as-is</span>
<span class="cstat-no" title="statement not covered" >  if (index === -1) {</span>
<span class="cstat-no" title="statement not covered" >    return value</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  const current = value[index]!</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  // The patch targets the item at the index specified by "head"</span>
<span class="cstat-no" title="statement not covered" >  // so forward it to the item</span>
<span class="cstat-no" title="statement not covered" >  const patchedItem = applyAtPath(tail, op, current)</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  // If the result of applying it to the item yields the item back we assume it was</span>
<span class="cstat-no" title="statement not covered" >  // a noop and don't modify our value. If we get a new value back, we return a</span>
<span class="cstat-no" title="statement not covered" >  // new array with the modified item replaced</span>
<span class="cstat-no" title="statement not covered" >  return patchedItem === current</span>
<span class="cstat-no" title="statement not covered" >    ? <span class="branch-0 cbranch-no" title="branch not covered" >current</span></span>
<span class="cstat-no" title="statement not covered" >    : splice(value, index, 1, [patchedItem])</span>
}
&nbsp;
