...
<head>
    <title>Code coverage report for src/apply/patch/applyOp.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/apply/patch</a> applyOp.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">127x</span>
<span class="cline-any cline-yes">127x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as operations from './operations'
import type {
  AnyOp,
  ArrayOp,
  NumberOp,
...
export function applyOp&lt;const Op extends Operation, const CurrentValue&gt;(
  ...
  if (!(op.type in operations)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
