...
<head>
    <title>Code coverage report for src/apply/utils/array.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/apply/utils</a> array.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">32x</span>
<span class="cline-any cline-yes">32x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {isKeyedElement} from '../../path'
...
<span class="cstat-no" title="statement not covered" >    `Expected path segment to be addressing a single array item either by numeric index or by '_key'. Instead saw ${JSON.stringify(</span>
<span class="cstat-no" title="statement not covered" >      pathSegment,</span>
