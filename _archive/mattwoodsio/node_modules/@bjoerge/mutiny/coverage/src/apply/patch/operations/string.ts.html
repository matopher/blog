...
<head>
    <title>Code coverage report for src/apply/patch/operations/string.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/apply/patch/operations</a> string.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {applyPatches, parsePatch} from '@sanity/diff-match-patch'
