...
<head>
    <title>Code coverage report for src/store/__test__/helpers.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/store/__test__</a> helpers.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {catchError, lastValueFrom, of, tap, toArray} from 'rxjs'
  ...
  const subscription = observable
    .pipe(
      tap({
        ...
        complete: <span class="fstat-no" title="function not covered" >() =&gt; emissions.push({kind: 'COMPLETE'}),</span>
      }),
      catchError(error =&gt; {
