...
<head>
    <title>Code coverage report for src/store/utils/mergeMutationGroups.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/store/utils</a> mergeMutationGroups.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import type {MutationGroup} from '../types'
&nbsp;
/**
...
export function chunkWhile&lt;T&gt;(
  ...
  if (currentChunk.length &gt; 0) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    res.push(currentChunk)</span>
