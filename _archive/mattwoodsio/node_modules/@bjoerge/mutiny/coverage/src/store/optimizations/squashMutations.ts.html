...
<head>
    <title>Code coverage report for src/store/optimizations/squashMutations.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/store/optimizations</a> squashMutations.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">6x</span>
<span class="cline-any cline-yes">6x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {groupBy} from 'lodash'
  ...
  return mergeMutationGroups(staged)
    ...
    .map(transaction =&gt; ({
      ...
      mutations: transaction.mutations.map(mutation =&gt; {
        if (mutation.type !== 'patch') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
export function squashCreateIfNotExists(mutations: Mutation[]): Mutation[] {
  if (mutations.length === 0) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
