...
<head>
    <title>Code coverage report for src/store/optimizations/squashNodePatches.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/store/optimizations</a> squashNodePatches.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {makePatches, stringifyPatches} from '@sanity/diff-match-patch'
import {takeUntilRight} from '../utils/arrayUtils'
import {getAtPath, startsWith, stringify} from '../../path'
import {applyNodePatch} from '../../apply'
import type {Path} from '../../path'
import type {Operation} from '../../mutations/operations/types'
import type {NodePatch, SanityDocumentBase} from '../../mutations/types'
&nbsp;
    ...
    (earlierPatches: NodePatch[], laterPatch: NodePatch) =&gt; {
      ...
      if (
        ...
        if (typeof current === 'string') {
          ...
          return earlierPatches
            .flatMap(ep =&gt; {
              return isEqualPath(ep.path, laterPatch.path<span class="branch-0 cbranch-no" title="branch not covered" >) &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >                ep.op.type === <span class="branch-0 cbranch-no" title="branch not covered" >'diffMatchPatch'</span></span>
