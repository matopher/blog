...
<head>
    <title>Code coverage report for src/store/rebase.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/store</a> rebase.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">85.71% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>120/140</span>
            </div>
...
<span class="cline-any cline-yes">11x</span>
<span class="cline-any cline-yes">11x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {applyPatches} from '../apply'
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function flattenMutations(mutations: Mutation[]) {</span></span>
<span class="cstat-no" title="statement not covered" >  return mutations.flatMap((mut): Mutation | Mutation[] =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (mut.type === 'patch') {</span>
<span class="cstat-no" title="statement not covered" >      return mut.patches.map(</span>
<span class="cstat-no" title="statement not covered" >        (patch): PatchMutation =&gt; ({</span>
<span class="cstat-no" title="statement not covered" >          type: 'patch',</span>
<span class="cstat-no" title="statement not covered" >          id: mut.id,</span>
<span class="cstat-no" title="statement not covered" >          patches: [patch],</span>
<span class="cstat-no" title="statement not covered" >        }),</span>
<span class="cstat-no" title="statement not covered" >      )</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return mut</span>
<span class="cstat-no" title="statement not covered" >  })</span>
<span class="cstat-no" title="statement not covered" >}</span>
&nbsp;
...
&nbsp;
  ...
  const dmpified = stagedMutations.map(transaction =&gt; {
    const mutations = transaction.mutations.flatMap(mut =&gt; {
      if (getMutationDocumentId(mut) !== documentId) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
      ...
      if (mut.type === 'dmpified') {
        ...
        try {
          ...
          try {
            ...
            applied.push(mut)
<span class="branch-0 cbranch-no" title="branch not covered" >          } catch (second: any) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(</span>
<span class="cstat-no" title="statement not covered" >              `Failed to apply patch for document "${documentId}": ${second.message}`,</span>
<span class="cstat-no" title="statement not covered" >            )</span>
<span class="cstat-no" title="statement not covered" >          }</span>
        }
      } else {
