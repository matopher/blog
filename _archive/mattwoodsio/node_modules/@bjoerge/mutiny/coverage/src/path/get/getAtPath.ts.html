...
<head>
    <title>Code coverage report for src/path/get/getAtPath.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/path/get</a> getAtPath.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">13x</span>
<span class="cline-any cline-yes">13x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {isArrayElement, isKeyedElement} from '../utils/predicates'
...
&nbsp;
  ...
  for (const head of path) {
    if (isArrayElement(head)) {
      if (!Array.isArray(current)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
