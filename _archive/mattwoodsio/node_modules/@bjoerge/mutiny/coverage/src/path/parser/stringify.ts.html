...
<head>
    <title>Code coverage report for src/path/parser/stringify.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/path/parser</a> stringify.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">59x</span>
<span class="cline-any cline-yes">59x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {isKeyedElement} from '../utils/predicates'
import type {Path, PathElement} from '../types'
&nbsp;
const IS_DOTTABLE = /^[a-z_$]+/
&nbsp;
function stringifySegment(segment: PathElement, hasLeading: boolean): string {
  if (Array.isArray(segment)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    return `[${segment[0]}:${segment[1] || ''}]`</span>
