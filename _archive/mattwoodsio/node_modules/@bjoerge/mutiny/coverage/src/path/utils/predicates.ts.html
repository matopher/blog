...
<head>
    <title>Code coverage report for src/path/utils/predicates.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/path/utils</a> predicates.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">34x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import type {KeyedPathElement, Path, PathElement} from '../types'
&nbsp;
...
&nbsp;
export <span class="fstat-no" title="function not covered" >function isEqual(path: Path, otherPath: Path): boolean {</span>
<span class="cstat-no" title="statement not covered" >  return (</span>
<span class="cstat-no" title="statement not covered" >    path.length === otherPath.length &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >    path.every((segment, i) =&gt; isElementEqual(segment, otherPath[i]))</span>
...
export function isElementEqual(
  ...
  if (isKeyElement(segmentA<span class="branch-0 cbranch-no" title="branch not covered" >) &amp;&amp; isKeyElement(segmentB)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >    return segmentA._key === segmentB._key</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
