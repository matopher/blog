...
export const article = {
  ...
  description:
    'YouTube = The 2nd largest search engine in the world. Want to rank number-one? Start with these quick wins to claim the top spot.',
}
...
- Use Youtube suggest to find long tail keywords (and use the `_` character to find words BEFORE.)
