...
export const article = {
  author: 'Matt Woods',
  date: '2019-09-16',
  title: 'Managing Oneself by Peter Drucker: Summary, Notes & Lessons',
  description:
    'This book is an essential (and classic) guide to sculpting your own effective career as a knowledge worker.',
}
...
<iframe width="100%" height="315" src="https://www.youtube.com/embed/YmT2XdHrWJo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
