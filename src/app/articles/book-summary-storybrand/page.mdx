...
export const article = {
  author: 'Matt Woods',
  date: '2019-09-23',
  title: 'Building a StoryBrand by Donald Miller: Summary, Notes & Lessons',
  description:
    'Anyone can use this framework to clarify their brand\'s message through razor-sharp storytelling to sell more stuff and help more people.',
}
...
<iframe width="100%" height="315" src="https://www.youtube.com/embed/r-lMQC-RiTg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
